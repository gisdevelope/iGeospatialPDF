...
public class Map {
	...
	private void calcOverAllBBox() {
		...
		for (int a = 0; a < this.getLayers().size(); a++) {
			...
			if (this.getLayers().get(a).getBbox().getDownLeft().getEasting() < this.getOverAllBBox().getDownLeft()
					.getEasting()
					|| this.getLayers().get(a).getBbox().getDownLeft().getNorthing() < this.getOverAllBBox()
							.getDownLeft().getNorthing()) {
			...
			if (this.getLayers().get(a).getBbox().getUpRight().getEasting() > this.getOverAllBBox().getUpRight()
					.getEasting()
