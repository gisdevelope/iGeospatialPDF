...
public class WebServicePDF_WMS_Test {
	...
	public static void main(String[] args) {
		...
		// BoundingBox bbox = new BoundingBox(new Point2D(5712125, 374676,
		// epsg),
		...
		WmsLayer layer1 = new WmsLayer(bbox, "www.wms.nrw.de/geobasis/wms_nw_dtk10?", layer, ServerVersion.WMS_V_1_3_0,
				100, 30, pdf.getPageWidth(), pdf.getPageHeight());
